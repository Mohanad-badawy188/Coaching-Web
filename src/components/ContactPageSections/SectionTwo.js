   ...
   <Container>
    <CartContainer style={{paddingTop:"100px"}}>
        <Cart>
            ...
            <Text><Icon src={Msg}/> glorynwokocha99@gmail.com</Text>
            <Text><Icon src={Phone}/>+234 806 774 735  </Text>
        </Cart>
        <Cart>
            <Header>Location</Header>
            <Text><IconRight src={Location}/> 88/89 Peter Odili Road, Port Harcourt, Rivers State.</Text>
        </Cart>
    </CartContainer>
   </Container>
  )
