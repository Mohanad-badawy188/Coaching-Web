  ...
  return (
    <Container>
      ...
      <RightSide>
        ...
        <Texts> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin consectetur justo quis euismod vehicula. Quisque diam dui, imperdiet et hendrerit in, accumsan tempus erat.Nullam ornare blandit urna.</Texts>
    <ServiceLi>
        <Vector src={VectorImg} /> <ServiceText>Post Marital Coaching</ServiceText>
         </ServiceLi>
    <ServiceLi>
        <Vector src={VectorImg}/> <ServiceText>Post Marital Coaching</ServiceText>
         </ServiceLi>
